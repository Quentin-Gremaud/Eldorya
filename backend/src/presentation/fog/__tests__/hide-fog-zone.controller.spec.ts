...
describe('HideFogZoneController', () => {
  let controller: HideFogZoneController;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      controllers: [HideFogZoneController],
      providers: [
    ...
    controller = module.get<HideFogZoneController>(HideFogZoneController);
  });

  it('should dispatch HideFogZoneCommand with correct params', async () => {
