...
describe('DropItemController', () => {
  let controller: DropItemController;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      controllers: [DropItemController],
      providers: [
        {
          provide: CommandBus,
    ...
    controller = module.get<DropItemController>(DropItemController);
    commandBus = module.get(CommandBus);
  });

  it('should dispatch DropItemCommand with correct data', async () => {
    ...
    expect(command).toBeInstanceOf(DropItemCommand);
