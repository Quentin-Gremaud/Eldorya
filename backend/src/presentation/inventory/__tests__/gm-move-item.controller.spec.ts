...
describe('GmMoveItemController', () => {
  let controller: GmMoveItemController;
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      controllers: [GmMoveItemController],
      providers: [
        {
          provide: CommandBus,
    ...
    controller = module.get<GmMoveItemController>(GmMoveItemController);
    commandBus = module.get(CommandBus);
  });

  it('should dispatch MoveItemCommand via GM authorization', async () => {
